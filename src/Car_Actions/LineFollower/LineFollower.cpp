...
void LineFollower::explore_maze() {
    reset();
...
uint8_t LineFollower::get_last_unknown_edge_index() {
...
uint8_t LineFollower::get_next_to_last_node(uint8_t start_node_index, uint8_t end_node_index, uint8_t ignore_edge_index = NO_EDGE_INDEX, bool ignore_battery_station = false) {
...
void LineFollower::drive_to_node(uint8_t node_index) {
...
void LineFollower::follow_path(const uint8_t *path, uint8_t path_length) {
...
void LineFollower::drive_loop_with_battery_charger() {
...
void LineFollower::drive_to_next_node() {
    follow_segment();
    drive_to_intersection_center();
}

void LineFollower::follow_segment(float distance = 0) {
    car->update();
...
void LineFollower::drive_to_intersection_center() {
...
void LineFollower::add_node_and_edges() {
    add_new_node();
...
void LineFollower::add_new_node() {
...
void LineFollower::add_edge_end(uint8_t start_node, uint8_t end_node, float length, uint8_t start_node_edge_index, uint8_t end_node_edge_index, float end_rotation) {
...
void LineFollower::add_unknown_edge(uint8_t current_node, float rotation) {
